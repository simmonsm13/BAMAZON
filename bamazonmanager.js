    ...
    .prompt([
      {
        name: "action",
        type: "list",
        message: "Select an option to manage inventory:",
        choices: [
          "Restock Inventory",
          "Add New Product",
    ...
    .prompt([
      {
        ...
        type: "input",
        message:
          "What is the item number of the product you would like to restock?"
      },
      {
        name: "Quantity",
        type: "input",
        message: "What amount you would like to add?"
      }
    ])
    .then(function(answers) {
  ...
  inquirer
    .prompt([
      ...
      },
      {
        name: "Name",
        type: "input",
        message: "Which product would you like to stock?"
      },
      {
        name: "Category",
        type: "input",
      ...
      },
      {
        name: "Price",
        type: "input",
        message: "How much is does the product cost?"
      },
      {
        name: "Quantity",
        type: "input",
